package com.example.giorgiosantomasi.musicplayer.mediaplayer;
...
import com.example.giorgiosantomasi.musicplayer.R;
...
import com.example.giorgiosantomasi.musicplayer.utils.PlaybackStatus;
...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private void updateMetaData() { //replace with medias albumArt
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        NotificationCompat.Builder notificationBuilder = (NotificationCompat.Builder) new NotificationCompat.Builder(this, "default")
                ...
                /*.setStyle(new NotificationCompat.Style().build().
